...
public class News_Schoolin_Activity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		initHandler();
		Util_ReadEntity.OLink(handler, Entity_Gth[].class,Util_Const.News_in,10000);
		initListen();
	}
		...
		handler = new Handler(){
			public void handleMessage(Message msg) {
				if (msg.arg1==200) {
					...
					listView.setAdapter(new Entity_GthAdapter(News_Schoolin_Activity.this,(Entity_Gth[])msg.obj, 
							R.layout.activity_listview_item_gth, cache));
				}else {
					Toast.makeText(News_Schoolin_Activity.this, "连接服务端失败", 2000).show();
				}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long arg3) {
		...
		Intent mIntent = new Intent(News_Schoolin_Activity.this,Inform_DetailsActivity.class);     

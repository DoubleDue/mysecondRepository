...
public class Inform_Schoolout_Activity extends Activity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		initHandler();
		Util_ReadEntity.OLink(handler, Entity_Gth[].class,Util_Const.Note_out,10000);
		initListen();
	}
		...
		handler = new Handler(){
			public void handleMessage(Message msg) {
				if (msg.arg1==200) {
					...
					listView.setAdapter(new Entity_GthAdapter(Inform_Schoolout_Activity.this,(Entity_Gth[])msg.obj, 
							R.layout.activity_listview_item_gth, cache));
				}else {
					Toast.makeText(Inform_Schoolout_Activity.this, "连接服务端失败", 2000).show();
				}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long arg3) {
		...
		Entity_Gth entity_Gth=(Entity_Gth) parent.getItemAtPosition(position);
		 Intent mIntent = new Intent(Inform_Schoolout_Activity.this,Inform_DetailsActivity.class);     

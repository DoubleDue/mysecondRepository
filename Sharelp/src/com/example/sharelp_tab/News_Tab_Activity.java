...
import com.example.sharelp_cooperation_news.News_Schoolin_Activity;
import com.example.sharelp_cooperation_news.News_Schoolout_Activity;
...
public class News_Tab_Activity extends TabActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent_share=new Intent().setClass(this, News_Schoolin_Activity.class);  
		spec_share=tabHost.newTabSpec("tab_share").setIndicator("校内新闻").setContent(intent_share);  
		tabHost.addTab(spec_share);
		//tabHost.getTabWidget().getChildAt(0).setBackgroundResource(R.drawable.a);


		intent_help=new Intent().setClass(this, News_Schoolout_Activity.class);  
		spec_help=tabHost.newTabSpec("tab_help").setIndicator("官方新闻").setContent(intent_help);  
